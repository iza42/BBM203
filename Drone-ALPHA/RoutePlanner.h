...
public:
    ...
    int visitedPriorityProvinces[MAX_PRIORITY_PROVINCES]; // I added checking every step if the current province is visited priority province
    int weatherRestrictedProvinces[MAX_WEATHER_RESTRICTED_PROVINCES];
    int skippedWeatherRestrictedProvinces[MAX_WEATHER_RESTRICTED_PROVINCES];
    ...
    int weatherestrictedcounter=0;
    int visited_priority_provinces_counter=0;
